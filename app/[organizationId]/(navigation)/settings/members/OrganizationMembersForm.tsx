...
import { updateOrganizationMemberAction } from "../organization.schema";
import type { OrganizationMemberFormSchemaType } from "../settings.schema";
import { OrganizationMemberFormSchema } from "../settings.schema";
import { OrganizationInviteMemberForm } from "./OrganizationInviteMemberForm";

type ProductFormProps = {
  defaultValues: OrganizationMemberFormSchemaType;
  members: {
    id: string;
    name: string | null;
    email: string;
...
export const OrganizationMembersForm = ({
  ...
  const form = useZodForm({
    schema: OrganizationMemberFormSchema,
    defaultValues,
  });
  const router = useRouter();

  const mutation = useMutation({
    mutationFn: async (values: OrganizationMemberFormSchemaType) => {
      ...
      router.refresh();
      form.reset(result.data as OrganizationMemberFormSchemaType);
    },
  });
